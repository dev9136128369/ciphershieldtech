...
//                 <button type="submit" className="btn1 btn-success btn-lg">Submit</button>
//               </div>
//             </form>
//           </div>
...
<div className="row contactus">
      ...
      <div className="container">
        <h1 className="page-title">Contact CipherShield Technologies <span className="decorative-line"></span></h1>
        ...
        <div className="contact-wrapper">
          ...
          <div className="contact-info">
            <div className="info-block">
              <h3><i className="fa fa-map-marker fa-spin" aria-hidden="true"></i> Address</h3>
              <img src={img1} alt="Address" className="info-img" />
            </div>

            <div className="info-block">
              <h3><i className="fa fa-phone fa-spin" aria-hidden="true"></i> Call Us</h3>
              <img src={img2} alt="Phone" className="info-img" />
            </div>

            <div className="info-block">
              <h3><i className="fa fa-envelope fa-spin" aria-hidden="true"></i> Email Us</h3>
              <img src={img3} alt="Email" className="info-img" />
            </div>
          </div>
        </div>
