      ...
      <div className="investor-header">
        <div className="investor-image">
          <picture>
            ...
            <img src={imageWebp} alt="Business Growth" loading="lazy" />
          </picture>
        </div>
        <div className="investor-title">
          <h1>
            Transforming Business Operations <br />
            with AI – For Better Growth and Return on Investment (ROI)
        ...
        <div className="investor-section">
          <div className="investor-left">
            <picture>
              ...
              <img src={image1Webp} alt="AI Investment Growth" loading="lazy" />
            </picture>
          </div>
