...
const RefundPolicy = () => {
  return (
    ...
    <Helmet>
        ...
        <meta
          name="description"
          content="Read the Terms and Conditions of CipherShield Technologies. We provide innovative technology solutions, automation services, and transparent contact policies to ensure data security."
        />
        <meta
          name="keywords"
