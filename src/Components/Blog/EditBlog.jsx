    ...
    const fetchPost = async () => {
      try {
        ...
        setPost({
          ...
          bannerImage: response.data.post.bannerImage || null,
  ...
  return (
    <div style={styles.container}>
      ...
      <form onSubmit={handleSubmit} style={styles.form}>
        ...
        <div style={styles.section}>
          <label style={styles.label}>Content Styles</label>
          <div style={styles.styleControls}>
            <label style={styles.checkboxLabel}>
              <input
                type="checkbox"
                name="bold"
                checked={post.contentStyles.bold}
            ...
            <label style={styles.checkboxLabel}>
              <input
                type="checkbox"
                name="italic"
                checked={post.contentStyles.italic}
                onChange={handleContentStyleChange}
              />
              Italic
            </label>
            <label style={styles.checkboxLabel}>
              <input
                type="checkbox"
                name="underline"
                checked={post.contentStyles.underline}
                onChange={handleContentStyleChange}
              />
              Underline
            </label>
        ...
        <div style={styles.section}>
          ...
          {post.bannerImage && (
            <div style={styles.imagePreviewContainer}>
              <img
                src={typeof post.bannerImage === 'string' 
                  ? `${apiBaseUrl}${post.bannerImage}`
          ...
          <div style={styles.mediaGrid}>
            {post.media.map((item, index) => (
              <div key={index} style={styles.mediaItem}>
                {item.url.match(/\.(jpeg|jpg|gif|png)$/) ? (
                  <img
                  ...
                  <div style={styles.filePreview}>
                    {typeof item === 'string' ? item.split('/').pop() : item.file.name}
                  </div>
                )}
                <button
                  type="button"
...
//     bannerImage: null,
//     media: [],
//     titleStyles: {  // Initialize with default values
//       bold: false,
//       italic: false,
//       underline: false,
//       fontSize: '24',
...
//       try {
//         const response = await axios.get(`${apiBaseUrl}/Components/Blog/blogpost/${postId}`);
//         // Ensure titleStyles exists with fallback to default values
//         console.log(response.data);
//         setPost({
//           title: response.data.post.title || '',
//           content: response.data.post.content || '',
