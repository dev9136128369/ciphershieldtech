...
const BlogEditor = ({ blogs = [], setBlogs = () => { }, currentUser }) => {
  ...
  const blogData = {
    title,
    content,
    mediaUrls: externalMedia.map(item => item.url),
    mediaTypes: externalMedia.map(item => item.type),
    mediaCaptions: media.map(item => item.caption),
    seoTitle,
    seoDescription,
...
//     alert('Blog has been successfully published!');
//     navigate('/dashboard/blogs');
//   };
