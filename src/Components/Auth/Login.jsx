...
const Login = ({ setIsLoggedIn, setCurrentUser }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // const response = await axios.post('http://localhost:8000/api/auth/logins', {
      //   email,
      //   password
      // });
      
      // const response = await axios.post('https://api.ciphershieldtech.com/api/auth/logins', { email, password });

      const response = await axios.post('http://localhost:8000/api/auth/logins', { email, password });
