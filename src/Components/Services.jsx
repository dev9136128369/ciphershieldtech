      ...
      <div className="container-fluid">
        ...
        <div className="container row language mb-5 text-center">
          <div className="col-lg-6 col-md-6 text-center">
            <picture>
              <source srcSet={`${img1Webp} 300w, ${img1Webp} 600w`} type="image/webp" />
              <source srcSet={`${img1Jpeg} 300w, ${img1Jpeg} 600w`} type="image/jpeg" />
              <img
                src={img1Jpg}
                alt="AI Power"
                loading="lazy"
          ...
          <div className="col-lg-6 col-md-6 languagepart mt-5">
            <h2 className="text-4xl font-bold">Our Technology Solutions</h2>
            <p className="textparte text-justify mt-4">
              From automation to deep-tech innovations, we offer solutions that drive efficiency,
              security, and scalability. AI-powered solutions provide companies with innovative
              tools to enhance productivity, optimize processes, and make data-driven decisions that
              can accelerate business growth. Below are key areas where AI-driven technologies can
              help businesses scale and thrive in today’s competitive landscape.
            </p>
          </div>
        </div>
